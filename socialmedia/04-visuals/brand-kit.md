...
**Set every price in JetBrains Mono.** Monospaced figures are the visual signature of the price-transparency position — they read as a receipt, not a promotion. `$999.00` in mono says something different from `$999.00` in a display face, and the difference is exactly the brand.
