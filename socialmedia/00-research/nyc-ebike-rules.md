...
1. **Verify both certificate numbers on Certipedia and screenshot the results.** The supplier invites this explicitly. The screenshot is your substantiation file if the claim is ever challenged — and in this city, in this year, it will be.
2. **Confirm NYC accepts TÜV Rheinland certification for Local Law 39.** The law requires certification by an accredited testing laboratory. TÜV Rheinland is major and widely recognised, but "certified to UL 2849 by TÜV Rheinland" and "UL Listed by UL Solutions" are different statements and some enforcement reads that narrowly. One email to FDNY or DCWP settles it.
